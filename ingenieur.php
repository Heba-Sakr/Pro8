...
<html lang="de-DE">
    ...
    <body>
        ...
        <div class="tab">
            <img src="assets/images/lms_logo_retina.png" style="width: 220px; padding-bottom: 5px;" />
      ...
      <table>
        <tbody>
            <tr> 
              <td> Bestellung-NR <a onclick="opentab(event, 'Offene Bestellung')">BestellungsNR</a> wartet auf eine Zustimmung </td> 
            </tr>
            <tr> 
            ...
            <tr>
              <td>Bestellung-NR  <a onclick="opentab(event, 'Bestellung-NR')">BestellungsNR</a> ist schon abgeholt.</td>
